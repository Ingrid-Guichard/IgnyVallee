 ...
 */
final class Version20200525191802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE activites (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE adherents (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, debut_adhesion DATE NOT NULL, fin_adhesion DATE NOT NULL, is_act_potager TINYINT(1) NOT NULL, is_act_verger TINYINT(1) NOT NULL, is_act_rucher TINYINT(1) NOT NULL, is_act_animation TINYINT(1) NOT NULL, is_act_promotion TINYINT(1) NOT NULL, is_int_potager TINYINT(1) NOT NULL, is_int_verger TINYINT(1) NOT NULL, is_int_rucher TINYINT(1) NOT NULL, is_int_animation TINYINT(1) NOT NULL, is_admin TINYINT(1) NOT NULL, prix_adhesion DOUBLE PRECISION DEFAULT NULL, is_payed TINYINT(1) NOT NULL, type_paiement VARCHAR(255) DEFAULT NULL, is_archive TINYINT(1) NOT NULL, valide TINYINT(1) NOT NULL, is_referent_p TINYINT(1) NOT NULL, is_referent_r TINYINT(1) NOT NULL, is_referent_v TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_562C7DA3E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE arbres (id INT AUTO_INCREMENT NOT NULL, adherent_id INT DEFAULT NULL, activite_id INT NOT NULL, colonne_arbre INT NOT NULL, ligne_arbre INT NOT NULL, nom_fruit_arbre VARCHAR(255) NOT NULL, etat_arbre VARCHAR(255) DEFAULT NULL, age_arbre INT DEFAULT NULL, fructification_arbre TINYINT(1) DEFAULT NULL, INDEX IDX_E6A4F22125F06C53 (adherent_id), INDEX IDX_E6A4F2219B0F88B1 (activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE parcelles (id INT AUTO_INCREMENT NOT NULL, activite_id INT NOT NULL, colonne_parcelle INT NOT NULL, ligne_parcelle INT NOT NULL, new_parcelle TINYINT(1) NOT NULL, etat_terre_parcelle VARCHAR(255) DEFAULT NULL, plantation_parcelle VARCHAR(255) DEFAULT NULL, historique1_plantation_parcelle VARCHAR(255) DEFAULT NULL, historique2_plantation_parcelle VARCHAR(255) DEFAULT NULL, historique3_plantation_parcelle VARCHAR(255) DEFAULT NULL, INDEX IDX_4F15F60E9B0F88B1 (activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recoltes_fruit (id INT AUTO_INCREMENT NOT NULL, activite_id INT NOT NULL, date_recolte_fruit DATE DEFAULT NULL, nom_fruit_recolte VARCHAR(255) NOT NULL, nb_kg_recolte_fruit DOUBLE PRECISION NOT NULL, prix_kg_fruit DOUBLE PRECISION DEFAULT NULL, INDEX IDX_ED6836829B0F88B1 (activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recoltes_legume (id INT AUTO_INCREMENT NOT NULL, activite_id INT NOT NULL, date_recolte_legume DATE NOT NULL, nom_legume_recolte VARCHAR(255) NOT NULL, nb_kg_recolte_legume DOUBLE PRECISION DEFAULT NULL, prix_legume DOUBLE PRECISION DEFAULT NULL, INDEX IDX_EBF6F48C9B0F88B1 (activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ruchers (id INT AUTO_INCREMENT NOT NULL, activite_id INT NOT NULL, nom_rucher VARCHAR(255) NOT NULL, description_rucher VARCHAR(255) DEFAULT NULL, lieu_rucher LONGTEXT DEFAULT NULL, partenaire_rucher VARCHAR(255) DEFAULT NULL, date_creation_rucher DATE DEFAULT NULL, INDEX IDX_76D62469B0F88B1 (activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sachets_graines (id INT AUTO_INCREMENT NOT NULL, activite_id INT NOT NULL, nom_graines VARCHAR(255) NOT NULL, nb_graines INT NOT NULL, saison_plantation_graines VARCHAR(255) DEFAULT NULL, qualite_graines VARCHAR(255) DEFAULT NULL, INDEX IDX_AE0611729B0F88B1 (activite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
