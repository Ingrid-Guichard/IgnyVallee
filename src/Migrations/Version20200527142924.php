 ...
 */
final class Version20200527142924 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE partenaires ADD lien_du_site VARCHAR(500) DEFAULT NULL, ADD description LONGTEXT DEFAULT NULL, ADD image_name VARCHAR(255) DEFAULT NULL, CHANGE date_partenariat date_partenariat DATE DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ateliers_taches (taches_id INT NOT NULL, ateliers_id INT NOT NULL, INDEX IDX_9AFA2E5FB8A61670 (taches_id), INDEX IDX_9AFA2E5FB1409BC9 (ateliers_id), PRIMARY KEY(ateliers_id, taches_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE ateliers_taches ADD CONSTRAINT FK_9AFA2E5FB1409BC9 FOREIGN KEY (ateliers_id) REFERENCES ateliers (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE ateliers_taches ADD CONSTRAINT FK_9AFA2E5FB8A61670 FOREIGN KEY (taches_id) REFERENCES taches (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE partenaires DROP lien_du_site, DROP description, DROP image_name, CHANGE date_partenariat date_partenariat DATE DEFAULT \'NULL\'');
