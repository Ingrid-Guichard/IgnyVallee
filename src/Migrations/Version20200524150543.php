 ...
 */
final class Version20200524150543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_3BF2CD989B0F88B1 ON taches (activite_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_3BF2CD989B0F88B1 ON taches');
    }
}
