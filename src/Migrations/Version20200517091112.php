 ...
 */
final class Version20200517091112 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adherents ADD is_referent_p TINYINT(1) NOT NULL, ADD is_referent_r TINYINT(1) NOT NULL, ADD is_referent_v TINYINT(1) NOT NULL, DROP is_referent, CHANGE prix_adhesion prix_adhesion DOUBLE PRECISION DEFAULT NULL, CHANGE type_paiement type_paiement VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adherents ADD is_referent VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, DROP is_referent_p, DROP is_referent_r, DROP is_referent_v, CHANGE prix_adhesion prix_adhesion DOUBLE PRECISION DEFAULT \'NULL\', CHANGE type_paiement type_paiement VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
