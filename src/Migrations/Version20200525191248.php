 ...
 */
final class Version20200525191248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE adherents ADD roles JSON NOT NULL, CHANGE prix_adhesion prix_adhesion DOUBLE PRECISION DEFAULT NULL, CHANGE type_paiement type_paiement VARCHAR(255) DEFAULT NULL, CHANGE mdp password VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE taches DROP activite_id');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE taches ADD activite_id INT NOT NULL');
    }
}
